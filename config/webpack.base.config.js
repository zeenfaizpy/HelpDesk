...
module.exports = (opts) => {
  ...
  return {
    ...
    entry: {
      main: path.resolve(PROJECT_ROOT, 'helpdesk/static/helpdesk/index'),
      vendor: ['react', 'redux', 'react-router', 'react-redux', 'react-dom'],
    },

    output: {
      path: path.resolve(PROJECT_ROOT, 'helpdesk/static/helpdesk/bundles'),
    ...
    resolve: {
      extensions: ['', '.js', '.jsx'],
      modules: [
        path.resolve(PROJECT_ROOT, 'helpdesk/static/helpdesk'),
        'node_modules',
      ],
    },
  };
